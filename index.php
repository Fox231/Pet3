...
<head>
    ...
    <title>Киноотеатры в Казани | Заказать билеты</title>
    <meta name="description" content=""><!-- ВСТАВИТЬ СЮДА ТЕКСТ -->
...
<body>
        ...
        <div class="conteiner">
            <header id="header">
                <div class="block1__row">
                    <div class="block1__col1">
                        <a href="http://university.innopolis.ru ">
                            <img src="images/logo.png" alt="logo" class="logo">
                        </a>
                    </div>
                    <div class="block1__col2">
                        <nav class="URL">
                            <ul>
                                <li><a href="#booking" class="URL-1 simple-text link-menu">ЗАКАЗАТЬ БИЛЕТ</a></li>
                                <li><a href="#advantages" class="URL-1 simple-text link-menu">ПРЕИМУЩЕСТВА</a></li>
                                <li><a href="#filmsling" class="URL-1 simple-text link-menu">ФИЛЬМЫ</a></li>
                                <li><a href="#contacts" class="URL-1 simple-text link-menu">КОНТАКТЫ</a></li>
                            </ul>
                        </nav>
                    </div>
                    <div class="block1__col3 text-right">
                        <p class="simple-text"><span>Ваш город:</span> <a id="city_name" href=""></a></p>
                    </div>
                </div>
            </header>
            <div class="header__headings">
                <h1 class="text-center">Закажите билет в кино</h1>
                <h2 class="text-center">Всем покупателям подарок!</h2>
            </div>
        </div>
    </div>

    <div class="content">
        <div id="advantages" class="Intro">
            <div class="Intro__welcome">
                <div class="Intro__welcome__content"></div>
                <h2 class="Intro__welcome__header">Добро пожаловать!</h2>
                <div class="Intro__text">
                    <p class="simple-text">Cumque dolorem eum harum laudantium libero molestias saepe soluta? Facere
                        minima optio
                        perferendis
            ...
            <h2 class="Intro__header">Почему мы?</h2>
        </div>


        <div class="Infoblocks">
            <div class="Infoblocks__conteiner">
                <div class="Infoblocks__image">
                    <img src="images/b2_icon_1.jpg" alt="Cinema Icon">
                </div>
                <h3 class="Infoblocks__header">Большие экраны</h3>
                <p class="Infoblocks__text simple-text">Lorem ipsum dolor sit amet, consectetur adipisicing elit. At
                    autem cum dolores dolorum eius error
                    expedita illum itaque molestiae mollitia nemo, nostrum officia quas ratione tempora temporibus
                    veritatis
                    vero voluptates.</p>
            </div>

            <div class="Infoblocks__conteiner Infolbocks__central-block">
                <div class="Infoblocks__image">
                    <img src="images/b2_icon_2.jpg" alt="Cinema Icon">
                </div>
                <h3>Объемный звук</h3>
                <p class="Infoblocks__text simple-text">Lorem ipsum dolor sit amet.</p>
            </div>

            <div class="Infoblocks__conteiner">
                <div class="Infoblocks__image">
                    <img src="images/b2_icon_3.jpg" alt="Cinema Icon">
                </div>
        ...
        <div id="booking" class="Mowie-menu">
            <h3 class="Mowie-menu-heading text-center">Выберите фильм</h3>
            <table id="filmsHire">
                <thead>
                    <tr id="table_head">
                        <th></th>
                        <th class="first_column text-center simple-text"><a href="">Начало сеанса
                                <svg width="15px" height="15px" viewBox="0 0 2 2" preserveAspectRatio="none">
                                    <polygon fill="white" points="1,0 2,2 0,2" />
                                </svg></a></th>
                        <th class="second_column simple-text"><a href="">Название фильма
                                <svg width="15px" height="15px" viewBox="0 0 2 2" preserveAspectRatio="none">
                                    <polygon fill="white" points="0,0 2,0 1,2" />
                                </svg>
                            </a></th>
                        <th class="simple-text">Жанр</th>
                        <th class="simple-text">Цена</th>
                </thead>
            </table>
            <p class="Mowie-menu-text text-center simple-text">Lorem ipsum dolor sit amet, consectetur adipisicing elit.
                Aliquid eum facere
                obcaecati
                quam rem repellendus veritatis. Aliquam beatae, delectus dignissimos enim exercitationem mollitia nisi
                pariatur quaerat quam, qui quibusdam sunt!</p>
        </div>
    </div>

    <div class="gifts">
        <div class="content">
            <img src="images/b4_img.jpg" alt="gifts-picture" id="gifts-picture">
            <div class="gifts__content">
                <h3 class="gifts__heading">Подарок каждому!</h3>
                <p class="gifts__text simple-text">Lorem ipsum dolor sit amet, consectetur adipisicing elit. Ab aperiam
                    aspernatur, cum, cupiditate
                    excepturi expedita libero mollitia nesciunt nihil nobis obcaecati quasi ratione reprehenderit sequi
                    sint, tenetur unde velit veniam! Lorem ipsum dolor sit amet, consectetur adipisicing elit. Ab
                    aperiam
                    aspernatur, cum, cupiditate excepturi expedita libero mollitia nesciunt nihil nobis obcaecati quasi
                    ratione reprehenderit sequi sint, tenetur unde velit veniam!</p>
                <p class="gifts__text simple-text">Lorem ipsum dolor sit amet, consectetur adipisicing elit. Ab aperiam
                    aspernatur, cum, cupiditate
                    excepturi expedita libero mollitia nesciunt nihil nobis obcaecati quasi ratione reprehenderit sequi
                    sint, tenetur unde velit veniam!</p>
                <p class="gifts__text simple-text">Lorem ipsum dolor sit amet, consectetur adipisicing elit. Ab aperiam
                    aspernatur, cum, cupiditate
                    excepturi expedita libero mollitia nesciunt nihil nobis obcaecati quasi ratione reprehenderit sequi
                    sint, tenetur unde velit veniam!</p>
                <div class="gifts-conteiner">
                    <button id="sendInfo" class="button">Получить подарок</button>
                </div>
            </div>
        </div>
    </div>
    ...
    <div class="content">
        <div id="filmsling" class="Films_logos">
            <h3 class="Films_logos_heading">Фильмы</h3>
            <p class="Films_logos_text simple-text">Lorem ipsum dolor sit amet, consectetur adipisicing elit. Ab
                adipisci alias,
                animi, commodi eius ipsum, laudantium neque nihil omnis perferendis sed sequi tempore! Ad ea esse ex
                inventore repudiandae, suscipit!</p>
            <div class="Films_logos_conteiner owl-carousel">
                <div class="Films__content">
                    <div class="Films__logos__inner">
                        <div class="Films__poster">
                            <img src="images/mov1.jpg" alt="Films Logo">
                        </div>
                        <div class="Films__discription">
                            <h4 class="Films__header">Человек-паук</h4>
                            <hr class="Films__hr">
                            <p class="Films__text simple-text">Lorem ipsum dolor sit amet, consectetur</p>
                            <div class="Films__URLs">
                                <a href="">
                                    <svg xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" width="0.472in" height="0.472in">
                                        <defs>
                ...
                <div class="Films__content">
                    <div class="Films__logos__inner">
                        <div class="Films__poster">
                            <img src="images/mov2.jpg" alt="Films Logo">
                        </div>
                        <div class="Films__discription">
                            <h4 class="Films__header">Собачья жизнь 2</h4>
                            <hr class="Films__hr">
                            <p class="Films__text simple-text">Lorem ipsum dolor sit amet, consectetur</p>
                            <div class="Films__URLs">
                                <a href="">
                ...
                <div class="Films__content">
                    <div class="Films__logos__inner">
                        <div class="Films__poster">
                            <img src="images/mov3.jpg" alt="Films Logo">
                        </div>
                        <div class="Films__discription">
                            <h4 class="Films__header">Люди в чёрном: Интернэшнл</h4>
                            <hr class="Films__hr">
                            <p class="Films__text simple-text">Lorem ipsum dolor sit amet, consectetur</p>
                            <div class="Films__URLs">
                                <a href="">
                ...
                <div class="Films__content">
                    <div class="Films__logos__inner">
                        ...
                        <div class="Films__discription">
                            <h4 class="Films__header">Люди в черном: Интернэшнл</h4>
                            <hr class="Films__hr">
                            <p class="Films__text simple-text">Lorem ipsum dolor sit amet, consectetur</p>
                            <div class="Films__URLs">
                                <a href="">
    ...
    <div id="contacts">
        <iframe src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d1120.5723791233092!2d49.149941289709496!3d55.82544667049655!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x415eb2af81a73f59%3A0x32e6cfa5bb586776!2sXL!5e0!3m2!1sru!2sru!4v1568804648265!5m2!1sru!2sru" width="100%" height="450" frameborder="0" style="border:0;" allowfullscreen=""></iframe>
    </div>
    ...
    <footer>
        <div class="footer_icon">
            <a href="">
                <svg xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" width="0.667in" height="0.667in">
                    <defs>
                    ...
                    <g filter="url(#Filter_1)">
                        <path fill-rule="evenodd" fill="rgb(255, 255, 255)" d="M23.499,44.999 C11.073,44.999 0.999,34.926 0.999,22.499 C0.999,10.073 11.073,-0.001 23.499,-0.001 C35.925,-0.001 45.999,10.073 45.999,22.499 C45.999,34.926 35.925,44.999 23.499,44.999 ZM30.994,30.137 C27.117,31.923 24.988,31.312 24.988,28.260 C24.988,26.670 24.992,21.993 24.992,21.993 L30.000,21.993 L30.000,17.981 L24.987,17.984 L24.987,11.959 C24.987,11.959 22.697,11.958 21.588,11.958 C21.402,14.735 20.468,16.307 17.014,18.005 C17.014,19.134 17.011,21.970 17.011,21.970 L20.000,21.970 C20.000,21.970 20.000,29.654 20.000,30.989 C20.000,33.629 22.408,34.654 24.119,34.904 C26.237,35.214 28.874,34.829 30.994,34.132 C30.994,32.886 30.994,31.757 30.994,30.137 Z" />
                    </g>
                </svg>
            </a>
            <a href="">
                <svg xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" width="0.681in" height="0.681in">
                    <defs>
                        <filter filterUnits="userSpaceOnUse" id="Filter_1" x="0px" y="0px" width="48px" height="48px">
                            <feOffset in="SourceAlpha" dx="0" dy="1" />
                            <feGaussianBlur result="blurOut" stdDeviation="1" />
            ...
            <a href="">
                <svg xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" width="0.667in" height="0.667in">
                    <defs>
                        <filter filterUnits="userSpaceOnUse" id="Filter_1" x="0px" y="0px" viewbox="48px">
                            <feOffset in="SourceAlpha" dx="0" dy="1" />
                            <feGaussianBlur result="blurOut" stdDeviation="1" />
                            <feFlood flood-color="rgb(0, 0, 0)" result="floodOut" />
                            <feComposite operator="atop" in="floodOut" in2="blurOut" />
                ...
                <div class="modal__form">
                    ...
                    <div class="input-wrap">
                        <div class="radio-wrap">
                            <input type="radio" id="radio1" name="popcorn" class="input-radio" value="Нужен попкорн">
                            <label for="radio1"><span></span>Нужен попкорн</label>
                        </div>
                        <div class="radio-wrap">
                            <input type="radio" id="radio2" name="popcorn" class="input-radio" value="Не люблю попкорн">
                            <label for="radio2"><span></span>Не люблю попкорн</label>
                        </div>
                    </div>
                    <div class="input-wrap">
        ...
        <div class="modal">
            ...
            <div class="modal__form">
                ...
                <div>
                    ...
                    <input type="number" value="1" step="1" id="orderFilmCountTicket">
                </div>
                <div>
                ...
                <div>
                    <span>Телефон:</span>
                    <input type="tel" pattern="3[0-9] {3}-[0-9]{3}" id="orderFilmPhone">
                </div>
                <div>
                    <span>Имя:</span>
                ...
                <div>
                    ...
                    <input type="number" id="PlaceChoice">
                </div>
                <div class="input-wrap">
                    <button id="sendOrder" class="button1">Отправить</button>
                </div>
                <div class="places">
    ...
    <div id="choose_city">
        <div class="modal">
            <button id="closeCityCoosing">X</button>
            <form action="">
                <fieldset>
                    <div class="modal__form">
                        <div class="input-wrap">
                            <input type="text" name="city_choose">
                        </div>
    ...
    <script src="js/getPresentInfo.js"></script>
